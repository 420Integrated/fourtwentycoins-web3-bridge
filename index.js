...
var providers = require('fourtwentycoins-providers');
var utils = require('fourtwentycoins-utils');
...
// Convert a Web3 Transaction into an fourtwentycoins.js Transaction
...
// Convert fourtwentycoins.js Block into Web3 Block
...
// Convert fourtwentycoins.js Transaction into Web3 Transaction
...
// Convert fourtwentycoins.js Transaction Receiptinto Web3 Transaction
...
// Convert fourtwentycoins.js Log into Web3 Log
...
function ProviderBridge(provider, signer) {
    ...
    utils.defineProperty(this, 'isFourtwentycoins', true);
    utils.defineProperty(this, 'isConnected', true);
    utils.defineProperty(this, 'fourtwentycoinsVersion', version);
    utils.defineProperty(this, 'client', 'fourtwentycoins/' + version);
...
utils.defineProperty(ProviderBridge.prototype, '_connectWeb3', function(web3) {
    this._web3 = web3;
    this._drainQueue();
});

utils.defineProperty(ProviderBridge.prototype, '_connectFourtwentycoins', function(provider, signer) {
    if (!signer) {
    ...
    switch (payload.method) {
        ...
        case 'personal_sign':
            signer.getAddress().then(function(address) {
                ...
                signer.signMessage(params[0]).then(function(signature) {
                    ...
                    respondError('fourtwenty_sign error', Errors.InternalError);
                });
            }, function(error) {
        ...
        case 'fourtwenty_sendTransaction':
            signer.getAddress().then(function(address) {
                ...
                respondError('fourtwenty_sendTransaction error', Errors.InternalError);
            });
            break;
        ...
        case 'fourtwenty_smokePrice':
            provider.getSmokePrice().then(function(smokePrice) {
                respond(smallHexlify(smokePrice));
            });
            break;
        ...
        case 'fourtwenty_estimateSmoke':
            provider.estimateSmoke(makeTransaction(params[0]), params[1]).then(function(data) {
                respond(data);
            });
            break;
...
utils.defineProperty(ProviderBridge.prototype, 'send', function(payload) {
    ...
    switch(payload.method) {
        ...
        // /Users/fourtwentycoins>  curl -H 'Content-Type: application/json' -X POST --data '{"jsonrpc":"2.0","method":"fourtwenty_protocolVersion","params":[],"id":67}' http://localhost:6174
